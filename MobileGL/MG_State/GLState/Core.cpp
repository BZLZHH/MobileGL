...
namespace MobileGL::MG_State {
    ...
    namespace GLState {
        ...
        void GLContext::SetSharedTextureObjectTable(const SharedPtr<SharedTextureObjectTable>& table) {
        ...
        void GLContext::SetSharedRenderbufferObjectTable(const SharedPtr<SharedRenderbufferObjectTable>& table) {
        ...
        void GLContext::SetSharedVertexArrayObjectTable(const SharedPtr<SharedVertexArrayObjectTable>& table) {
