// MobileGL - MobileGL/MG_Test/Transport/ClientDrawArraysTest.cpp
...
namespace {
    ...
    void TestDrawArrays(MobileGLBackend* backend, MobileGLSessionId session,
...
namespace MobileGL::Transport {
    TEST(ClientDrawArraysTest, TypedDrawArraysPayload) {
        g_mode = 0;
        g_first = 0;
        g_count = 0;
        ...
        vtable.DrawArrays = &TestDrawArrays;
        ...
        EXPECT_TRUE(Client::SubmitSessionControl(6, true, 1));
        EXPECT_TRUE(Client::WaitResponseForToken(1, 5000));
        EXPECT_TRUE(Client::SendDrawArrays(6, 4, 3, 6, 2));
