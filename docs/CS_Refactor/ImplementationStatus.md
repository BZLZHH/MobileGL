...
- **全量 ctest（unit）**：1434/1434 通过（3 skipped）✅（含 BufferRespecify / Indirect / GetString / TextureRespecify / ReadPixels 服务端→客户端 shm 新测试）
...
- [ ] TextureSubImage / Map-Unmap / 批量零拷贝（下一轮）
