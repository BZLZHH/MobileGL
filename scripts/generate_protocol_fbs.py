...
MobileGL/MG_Protocol/protocol.fbs; this generator produces
MobileGL/MG_Protocol/protocol_generated.fbs, which the Phase 4 codegen merges
...
def main() -> int:
    ...
    header = (
        ...
        "// Merge into MobileGL/MG_Protocol/protocol.fbs at the\n"
